...
** MAC Use Option as Meta key

#+source: option-is-meta tangle: no
#+begin_src emacs-lisp 
  (setq mac-option-modifier 'meta)    
#+end_src

** Use Command-Z as undo and other generic key bindings
Option to use some generic Mac and Windows key bindings.
#+source: mackeys1
#+begin_src emacs-lisp 
